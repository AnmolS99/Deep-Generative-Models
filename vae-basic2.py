...
from variational_autoencoder2 import VariationalAutoEncoder2
...
class VAEBasic2:
    ...
    def __init__(self,
        ...
        self.var_autoencoder = VariationalAutoEncoder2(latent_dim)
    ...
    def show_figure(self, n, original, reconstructed):
        ...
        # Choosing filepath
        if self.three_colors:
            path = "./results/vae-basic-color2"
        else:
            path = "./results/vae-basic-mono2"
...
if __name__ == "__main__":
    vae_basic2 = VAEBasic2(latent_dim=4,
                           three_colors=True,
                           save_image=False,
                           save_weigths=False)
